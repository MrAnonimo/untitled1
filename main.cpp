...
int main(int argc, char *argv[])
{
    ...
    if(arduino_available)
    {
        ...
        QObject::connect(arduinoReader,SIGNAL(gotNewVals(const QString&,const QString&,const QString&)),&w, SLOT(updateWindowData(const QString&,const QString&,const QString&)));
